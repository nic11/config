...
export ZSH="$HOME/my/config/ohmyzsh"
...
if [ -e /home/roma/.nix-profile/etc/profile.d/nix.sh ]; then . /home/roma/.nix-profile/etc/profile.d/nix.sh; fi # added by Nix installer
